...
require (
	...
	github.com/colespringer/waxtap/v3 v3.1.2
)

require (
	github.com/colespringer/waxflow v0.0.0-20260805235143-c6100344a117 // indirect
	github.com/colespringer/waxlabel v1.3.0 // indirect
